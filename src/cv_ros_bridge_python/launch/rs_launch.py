...
configurable_parameters = [
    ...
    },
    {
        "name": "rosbag_loop",
        "default": "false",
        "description": "Enable loop playback when playing a bagfile",
    },
    {
        "name": "log_level",
        "default": "info",
    ...
    },
    {
        ...
        "default": "0,0,0",
        "description": "Depth module color stream profile for d405",
    },
    {
        "name": "depth_module.color_format",
        "default": "RGB8",
        "description": "color stream format for d405",
    },
    {
    ...
    {
        "name": "depth_module.inter_cam_sync_mode",
        "default": "0",
        "description": "[0-Default, 1-Master, 2-Slave]",
    },
    ...
    {"name": "gyro_fps", "default": "0", "description": "''"},
    {
        "name": "enable_motion",
        "default": "false",
        "description": "'enable motion stream (IMU) for DDS devices'",
    },
    ...
    {
        "name": "rotation_filter.enable",
        "default": "false",
        "description": "enable rotation_filter",
    },
    {
        "name": "rotation_filter.rotation",
        "default": "0.0",
        "description": "rotation value: 0.0, 90.0, -90.0, 180.0",
    },
    {
    ...
    },
    {
        "name": "base_frame_id",
        "default": "link",
        "description": "Root frame of the sensors transform tree",
    },
]
...
def launch_setup(context, params, param_name_suffix=""):
    ...
    node_action = (
        ...
        else launch_ros.actions.Node
    )
    log_message = (
        "Launching as LifecycleNode"
        if use_lifecycle_node
        else "Launching as Normal ROS Node"
    )
